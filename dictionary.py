...
#урон вычисляется по формуле урон-защита *1.2
# добавить игроку силу, в зависимости от которой защита и здоровье будут повышаться
# защита = защита + сила // 2
# здоровье = здоровье + сила // 2
